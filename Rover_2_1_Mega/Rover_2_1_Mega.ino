...
//Pins ps2 Controller
#define PS2_DAT        22  //Pin Data is plugged into
#define PS2_CMD        23  //Pin Command is plugged into
#define PS2_SEL        2  //Pin Attention is plugged into
#define PS2_CLK        3  //Pin Clock is plugged into
